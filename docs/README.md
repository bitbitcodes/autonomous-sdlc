...
Comprehensive documentation for the **Autonomous SDLC Framework**.

## Contents

| Document | Description |
|----------|-------------|
| [Getting Started](getting-started.md) | Installation, first run, and walkthrough |
...
| [MCP Integrations](mcp-integrations.md) | JIRA, GitHub, Database MCP servers |

## Quick Links

- [AGENTS.md](../AGENTS.md) — Agent discovery file (OpenAI/AAIF standard)
