...
def _init_runtime_state(target_dir: Path) -> None:
    ...
    state = {
        ...
        "complexity": None,
        "phases": {
            "0-bootstrap": {"status": "pending", "gate": None},
            "1-product": {"status": "pending", "gate": None},
            "2-architecture": {"status": "pending", "gate": None},
            "3-backlog": {"status": "pending", "gate": None},
            "4-development": {"status": "pending", "gate": None},
            "5-testing": {"status": "pending", "gate": None},
            "6-security": {"status": "pending", "gate": None},
            "7-review": {"status": "pending", "gate": None},
            "8-devops": {"status": "pending", "gate": None},
            "9-observability": {"status": "pending", "gate": None},
        },
        "active_agents": [],
        "total_tasks": 0,
        "completed_tasks": 0,
