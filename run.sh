...
VERSION="$(python3 -c "import sys, os; sys.path.insert(0, os.path.join('${PROJECT_ROOT}', 'src')); from sdlc_cli.version import __version__; print(__version__)" 2>/dev/null || echo "4.2.0")"
